...
public class AcidFileSystem extends GenericFileSystem {
    ...
    // temporary file which is a to-be committed file.
    // 4. To do '2' and '3', probably need to implement some TOC mechanism.
    //
    //
    // - Keep track of un-committed or un-rollbacked changes.
    //
    // 1. Add a filename extension as a directive for uncommitted files.
    // But, what about rollback?
    // 2. Some sort of summary/log files for un-executed changes.
    ...
    private final TerminatableThread evictor = new TerminatableThread() {
        @Override
        public void run() {
            running = true;
     ...
     *
     * @return transactional interface
     */
    @SuppressWarnings("WeakerAccess")
    ...
    public class Transaction extends FileSystem implements Terminatable {
        final AcidFileSystem filesystem;
        /**
         * Map of {@link TimestampedLock} owned this transaction
         */
        final Map<String, TimestampedLock> locks = new ConcurrentHashMap<>();
        /**
         * Update actions
         */
        ...
        /**
         * @param filesystem parent file system
         */
        ...
        private void reserveLock(String path) {
            ...
            // for acquisition may result in starvation.
    ...
    class Action {
         ...
         */
        final List<Operation> commit = new ArrayList<>();
        /**
         * Operations to do a rollback
         */
        final List<Operation> rollback = new ArrayList<>();
    ...
    class Operation {
         ...
         * @param source    source file path (can't be null)
         * @param target    target file path (can't be null for rename)
         */
